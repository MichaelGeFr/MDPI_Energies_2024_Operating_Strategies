...
ControlLogic.c1 = Var(ControlLogic.C, ControlLogic.P, ControlLogic.T, bounds = Binary, doc = "fullfillment variable to determine, wheter converter C is at priority P (C, P, T)")
# ControlLogic.c2 = Var(ControlLogic.C, ControlLogic.P, ControlLogic.J, bounds = (0,1), doc = "fullfillment variable to determine, wheter converter C is at priority P in decision rule J (C, P, J)") 
# ControlLogic.c3 = Var(ControlLogic.C, ControlLogic.P, ControlLogic.J, ControlLogic.T, bounds = (0,1), doc = "fullfillment variable to determine, wheter converter C is at priority P in decision rule J at time T (C, P, J ,T)") 

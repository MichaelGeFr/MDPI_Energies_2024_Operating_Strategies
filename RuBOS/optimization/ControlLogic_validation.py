...
ControlLogic.c1 = Var(ControlLogic.C, ControlLogic.P, ControlLogic.T, within = Binary, doc = "fullfillment variable to determine, wheter converter C is at priority P (C, P, T)")
ControlLogic.c3 = Var(ControlLogic.C, ControlLogic.P, ControlLogic.J, ControlLogic.T, within = Binary, doc = "fullfillment variable to determine, wheter converter C is at priority P in decision rule J at time T (C, P, J ,T)") 
ControlLogic.d = Var(ControlLogic.C, ControlLogic.P, ControlLogic.T, within = Binary, doc = "approval variable of converter C (C, P, T)")
...
### parameters ###
ControlLogic.thres = Param(ControlLogic.I, domain = Reals, doc = "threshold values (I)")
ControlLogic.c2 = Param(ControlLogic.C, ControlLogic.P, ControlLogic.J, within = Binary, doc = "fullfillment variable to determine, wheter converter C is at priority P in decision rule J (C, P, J)") 
